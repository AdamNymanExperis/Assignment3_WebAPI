    ...
    public class MovieDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder) 
        {
            modelBuilder.Entity<Movie>().HasData(
                    ...
                    new Movie { Id = 5, Title = "Star Wars Episode VI", Genre = "Sci-fi", Director = "George Lucas", Picture = "https://m.media-amazon.com/images/M/MV5BYTRhNjcwNWQtMGJmMi00NmQyLWE2YzItODVmMTdjNWI0ZDA2XkEyXkFqcGdeQXVyNTAyODkwOQ@@._V1_.jpg", Trailer = "https://www.youtube.com/watch?v=RlT3Xg0Iq_g", FranchiseId = 3 },
                    new Movie { Id = 6, Title = "Star Wars: Episode II", Genre = "Sci-fi", Director = "George Lucas", Picture = "https://m.media-amazon.com/images/M/MV5BYTRhNjcwNWQtMGJmMi00NmQyLWE2YzItODVmMTdjNWI0ZDA2XkEyXkFqcGdeQXVyNTAyODkwOQ@@._V1_.jpg", Trailer = "https://www.youtube.com/watch?v=RlT3Xg0Iq_g", FranchiseId = 3 },
                    new Movie { Id = 7, Title = "Star Wars: Episode III", Genre = "Sci-fi", Director = "George Lucas", Picture = "https://m.media-amazon.com/images/M/MV5BYTRhNjcwNWQtMGJmMi00NmQyLWE2YzItODVmMTdjNWI0ZDA2XkEyXkFqcGdeQXVyNTAyODkwOQ@@._V1_.jpg", Trailer = "https://www.youtube.com/watch?v=RlT3Xg0Iq_g", FranchiseId = 3 },
                    new Movie { Id = 8, Title = "The Incredible Hulk", Genre = "Action", Director = "Stan Lee", Picture = "https://m.media-amazon.com/images/M/MV5BMTczNTI2ODUwOF5BMl5BanBnXkFtZTcwMTU0NTIzMw@@._V1_FMjpg_UX1000_.jpg", Trailer = "https://www.youtube.com/watch?v=RsCSvPIcIpw", FranchiseId = 1 },
                    new Movie { Id = 9, Title = "Avengers", Genre = "Action", Director = "Stan Lee", Picture = "https://m.media-amazon.com/images/M/MV5BMTczNTI2ODUwOF5BMl5BanBnXkFtZTcwMTU0NTIzMw@@._V1_FMjpg_UX1000_.jpg", Trailer = "https://www.youtube.com/watch?v=RsCSvPIcIpw", FranchiseId = 1 }
                 );
            modelBuilder.Entity<Character>().HasData(
                    ...
                    new Character { Id = 5, FullName = "Jabba Desilijic Tiure", Alias = "Jabba the Hut", Picture = "https://m.media-amazon.com/images/M/MV5BMTczNTI2ODUwOF5BMl5BanBnXkFtZTcwMTU0NTIzMw@@._V1_FMjpg_UX1000_.jpg" },
                    new Character { Id = 6, FullName = "Obiwan Kenobi", Alias = "Ben", Picture = "https://m.media-amazon.com/images/M/MV5BYTRhNjcwNWQtMGJmMi00NmQyLWE2YzItODVmMTdjNWI0ZDA2XkEyXkFqcGdeQXVyNTAyODkwOQ@@._V1_.jpg" },
                    new Character { Id = 7, FullName = "Bruce Banner", Alias = "The Hulk", Picture = "https://m.media-amazon.com/images/M/MV5BYTRhNjcwNWQtMGJmMi00NmQyLWE2YzItODVmMTdjNWI0ZDA2XkEyXkFqcGdeQXVyNTAyODkwOQ@@._V1_.jpg" },
                    new Character { Id = 8, FullName = "Steve Roger", Alias = "Captain America", Picture = "https://m.media-amazon.com/images/M/MV5BYTRhNjcwNWQtMGJmMi00NmQyLWE2YzItODVmMTdjNWI0ZDA2XkEyXkFqcGdeQXVyNTAyODkwOQ@@._V1_.jpg" }
                );
                ...
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    je =>
                    {
                        ...
                        je.HasData(
                            ...
                            new { MovieId = 7, CharacterId = 3 },
                            new { MovieId = 7, CharacterId = 6 },
                            new { MovieId = 8, CharacterId = 7 },
                            new { MovieId = 9, CharacterId = 1 },
                            new { MovieId = 9, CharacterId = 7 },
